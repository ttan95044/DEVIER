...
import 'package:luanvanapp/bard_ai/bard_ai_screen/ethnic_hoa/bard_ai_controller_hoa.dart';

class AiEthnicHoa extends StatelessWidget {
  const AiEthnicHoa({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    BardAIControllerHoa controller = Get.put(BardAIControllerHoa());
