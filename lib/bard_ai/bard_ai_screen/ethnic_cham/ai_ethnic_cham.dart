...
import 'package:luanvanapp/bard_ai/bard_ai_screen/ethnic_cham/bard_ai_controller_cham.dart';

class AiEthnicCham extends StatelessWidget {
  const AiEthnicCham({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    BardAIControllerCham controller = Get.put(BardAIControllerCham());
