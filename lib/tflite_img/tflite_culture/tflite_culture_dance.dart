...
class TfliteCultureDance extends StatefulWidget {
  final File image;

  const TfliteCultureDance({Key? key, required this.image}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _TfliteCultureDanceState createState() => _TfliteCultureDanceState();
}

class _TfliteCultureDanceState extends State<TfliteCultureDance> {
  late List _results = [];
  int numResults = 5;
                    ...
                    children: [
                      ...
                      if (label == "khac")
                        ElevatedButton(
                          ...
                          child: const Text("Xem dân chi tiết những dân tộc khác"),
                        ),
                    ],
                  ),
                );
