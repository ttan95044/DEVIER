...
class TfliteCultureMarriage extends StatefulWidget {
  final File image;

  const TfliteCultureMarriage({Key? key, required this.image})
      : super(key: key);
...
class _TfliteCultureMarriageState extends State<TfliteCultureMarriage> {
  late List _results = [];
  int numResults = 5;
